import com.baeldung.reflection.Bird;
import com.baeldung.reflection.Goat;
import com.baeldung.reflection.Person;
...
public class ReflectionTest {
    ...
    @Test
    public void givenClassField_whenSetsAndGetsValue_thenCorrect() throws ClassNotFoundException, IllegalAccessException, InstantiationException, NoSuchFieldException {
        Class<?> birdClass = Class.forName("com.baeldung.reflection.Bird");
    ...
    @Test
    public void givenMethod_whenInvokes_thenCorrect() throws ClassNotFoundException, IllegalAccessException, InstantiationException, NoSuchMethodException, InvocationTargetException {
        Class<?> birdClass = Class.forName("com.baeldung.reflection.Bird");
        Bird bird = (Bird) birdClass.newInstance();
        Method setWalksMethod = birdClass.getDeclaredMethod("setWalks", boolean.class);
        Method walksMethod = birdClass.getDeclaredMethod("walks");
